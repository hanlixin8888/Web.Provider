...
function InitGridMain() {
    ...
    grid = $('#tab_list').datagrid({
        ...
        //{ field: 'ck', checkbox: true },
                    ...
                    { field: 'SheetID', title: '采购进货单号', width: 120, align: 'center', sortable: true },
                    { field: 'RefSheetID', title: '采购订单号', width: 120, align: 'center', sortable: true },
                    { field: 'PayTypeName', title: '结算方式', width: 120, align: 'center', sortable: true },
                    { field: 'PurType', title: '采购类型', width: 90, align: 'center', sortable: true },
                    { field: 'TotalQty', title: '总数量', width: 90, align: 'center', sortable: true },
                    { field: 'TotalCostValue', title: '总金额', width: 80, align: 'center', sortable: true },
                    { field: 'Editor', title: '制单人', width: 90, align: 'center', sortable: true },
                    { field: 'CheckDate', title: '下单时间', width: 90, align: 'center', sortable: true, formatter: ChangeDateFormat },
                    { field: 'Flag', title: '订单状态', width: 90, align: 'center', sortable: true, formatter: formatflag },
...
$(function () {
    $('#tab_list').datagrid({
        ...
        onExpandRow: function (index, row) {
            ...
            ddv.datagrid({
                url: '/PurchaseIn/QueryDetailData' + '?sheetid=' + row.SheetID,
                fitColumns: true,
                singleSelect: true,
                rownumbers: true,
                loadMsg: '',
