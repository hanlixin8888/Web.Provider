...
{
    [DataContract]
    [MB.Orm.Mapping.Att.ModelMap("PurchaseOutMain", "PurchaseOutMain", new string[] { "SheetID" })]
    [KnownType(typeof(PurchaseMain))]
    public class PurchaseOutMain:MB.Orm.Common.BaseModel
    {
        /// <summary>
        /// 采购退货单号
        /// </summary>
        ...
        {
            get { return _TotalSaleValue; }
            set { _TotalSaleValue = value; }
        }
